...
function displayWords(wordArr) {
    ...
    for (let word of wordArr) {
        if (word.match(pangramWordReg)) {
            ...
            wordsListHTML += `<li class= "pangram"><a href="https://duckduckgo.com/?t=ffab&q=${word}+defintion&ia=web" target="_blank">${word}</a></li>`
            continue
        }

        wordsListHTML += `<li><a href="https://duckduckgo.com/?t=ffab&q=${word}+defintion&ia=web" target="_blank">${word}</a></li>`
    }
